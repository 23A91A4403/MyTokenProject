...
contract MyToken {
    ...
    // Track balances: address => balance
    ...
    // Optional helper function to get total supply explicitly
    function getTotalSupply() public view returns (uint256) {
        return totalSupply;
    }

    // Optional helper function to get token information in a single call
